 ...
 * <li>you can change preference name by
 * {@link #getDefaultSharedPreferencesName(context)}</li>
 * </ul>
 * <ul>
...
public class PreferencesUtils {
	...
	public static boolean putString(Context context, String key, String value) {
		SharedPreferences settings = context.getSharedPreferences(getDefaultSharedPreferencesName(context), Context.MODE_PRIVATE);
	...
	/**
	 * android2.3使用SharedPreferences存储字符串集合类型的元素
	 * 
	 * @param prefs
	 * @param key
	 * @param defValues
	 * @return
	 */
	public static List<String> getStringList(SharedPreferences prefs, String key, List<String> defValues) {
	...
	public static boolean putStringList(SharedPreferences.Editor ed, String key, List<String> values) {
		String str = "";
